...
export const WhatsAppWidget: React.FC = () => {
  ...
  const handleWhatsAppClick = () => {
    const phoneNumber = '+923289682170';
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 w-14 h-14 bg-green-500 text-white rounded-full shadow-lg hover:bg-green-600 transition-all duration-300 z-50 flex items-center justify-center"
      >
      ...
      {/* Chat Bubble */}
      {isOpen && (
        <div className="fixed bottom-24 right-6 w-80 bg-white rounded-lg shadow-xl border border-gray-200 z-50 animate-in slide-in-from-bottom-5">
          {/* Header */}
