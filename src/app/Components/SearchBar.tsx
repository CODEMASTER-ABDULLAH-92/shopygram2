...
import { ProductItem } from '../types/product';
 ...
 const products = [
    ...
    },
    {
      ...
      name: "Diamond Ring",
      category: "Jewelry",
      description: "Elegant diamond ring in gold setting",
      price: "$899"
    },
    {
      id: 8,
      ...
      description: "Stand mixer for baking and cooking",
      price: "$249"
    }
  ];
const SearchBar = () => {
    ...
    >
      <div className="flex justify-between items-start">
        ...
        {isSearchOpen && searchQuery && searchResults.length === 0 && (
          <div className="absolute top-full left-0 right-0 mt-2 bg-white/95 backdrop-blur-md border border-white/30 rounded-2xl shadow-xl z-50 p-6">
